 ...
 $().ready(function(){
		$("form input").blur(function(){
			...
			if($(this).is("#password2")) {
				...
				if($.trim(this.value) !=$.trim(password) ) {
					var errorMsg = " 密码不一样！";
					//class='msg onError' 中间的空格是层叠样式的格式
					$parent.append("<span class='msg high'>" + errorMsg + "</span>");
					return false;
...
<body>
	...
	<form class="form-horizontal" id="form" action="user?type=zhuce" method="post">
  ...
  <div class="form-group">
  <label for="inputPassword3" class="col-sm-3 control-label color">确认密码</label>
    <div class="col-sm-7">
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-4">
      <button type="submit" class="btn btn-success btn-lg" style="width: 200px"  id="send">注册</button>
    </div>
  </div>
  <div class="form-group">
  	<div class="col-sm-offset-3 col-sm-4">
    	<a href="user">已注册账号，请登录</a>
  </div>
   </div>
